...
public class DefaultCategoryMapper implements CategoryMapper{
    ...
    private final CategoryPartUpdatingMapper categoryPartUpdatingMapper = CategoryPartUpdatingMapper.MAPPER;
    ...
    @Override
    public Category mapFromCategoryPartUpdatingDtoToCategory(CategoryPartUpdatingDto categoryPartUpdatingDto) {
        return categoryPartUpdatingMapper.mapToCategory(categoryPartUpdatingDto);
    }
}
